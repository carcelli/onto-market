...
ANNOTATIONS: dict[str, str] = {
    ...
    "src/onto_market/devtools/repo_tools/import_graph.py": "⏳ Scaffold for cross-module import graph analysis",
    "src/onto_market/devtools/repo_tools/boundary_matrix.py": "⏳ Scaffold for architecture boundary checks",
    "src/onto_market/devtools/repo_tools/cycle_detector.py": "⏳ Scaffold for dependency cycle detection",
    "src/onto_market/devtools/repo_tools/architecture_drift.py": "⏳ Scaffold for rule-based drift audits",
    ...
    layers = [
        ...
        (
            ...
            [
                ...
                ("`src/onto_market/devtools/repo_tools/import_graph.py`", "Future import-graph analyzer scaffold"),
            ],
        ),
        (
