...
**⚠ 2 violation(s) found. Each represents an import that crosses a forbidden layer boundary.**
...
| 2 | `onto_market.utils.llm_client` | `onto_market.core.llm_router` | 'utils' is not permitted to import from 'core' under the current layering policy |
...
| `main` | `agents`, `config`, `core`, `ontology`, `utils` |
